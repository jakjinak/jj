...
struct literals_t<wchar_t>
{
    ...
    static const wchar_t ASTERISK = L'*';
    static const wchar_t APOSTROPHE = L'\'';
    static const wchar_t BAPOSTROPHE = L'`';
    static const wchar_t QUOTE = L'"';
    static const wchar_t AT = L'@';
    static const wchar_t LRB = L'(';
    static const wchar_t RRB = L')';
    static const wchar_t LCB = L'{';
    static const wchar_t RCB = L'}';
    static const wchar_t LSB = L'[';
    static const wchar_t RSB = L']';
    static const wchar_t LAB = L'<';
    static const wchar_t RAB = L'>';
